...
var vir_mir_list_post = React.createClass({
        ...
        return (
            <div className="row">
                <div className="col-xs-12">
                    ...
                    <div className="row">
                        <div className="col-xs-6 icon__posts">
                            <a href="#">
                        ...
                        <div className="col-xs-6">
                            <div className="pull-right date__posts">
                            23 июля 15:10
                            </div>
                        </div>
                    </div>
